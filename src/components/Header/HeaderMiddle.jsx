...
import logo from "../../assets/icons/uzum-logo.svg"
import {CatalogueIcon, SearchIcon, UserIcon, LoveIcon, CartIcon} from "../HeaderIcons";
const HeaderMiddle = () => {
    return (
        <div className="flex items-center justify-between mb-[11px] pt-[18px]">
          ...
          <div className="flex gap-x-[7px]">
            ...
            <div className="flex items-center justify-between rounded-[4px] border border-gray-100 overflow-hidden w-[520.38px] h-[40px]">
              <input className="w-full outline-none border-none py-[11.5px] px-[17px]" type="search" placeholder="Искать товары и категории"/>
              <span className="w-[78.05px] flex items-center justify-center bg-gray-100 h-full"><SearchIcon/></span>
            </div>
          </div>
